package com.cdcrane.cloudary.auth.filter;
...
import com.cdcrane.cloudary.auth.internal.SecurityConfig;
        ...
        if (jwt != null && jwt.startsWith("Bearer ")) {
            ...
            try {
                ...
                Authentication auth = new UsernamePasswordAuthenticationToken(
                        new CloudaryUserPrincipal(userId, username, null, authoritiesCollection, true),
